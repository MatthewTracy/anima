...
const commandList = queryList.concat(actionsList).concat(governanceActionsList).concat(governanceQueryList).concat(anarchyActionsList).concat(anarchyQueryList);
const commandMap = {};
